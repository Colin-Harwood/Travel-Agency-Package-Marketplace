...
<body>
    <main class="hero">
        ...
        <section class="hero-card">
            ...
            <p>
                Find the perfect travel experience, explore packages from trusted agencies,
        ...
        <section class="logo-section">
            <img src="logo.png" alt="Tripistry logo" class="main-logo">
        </section>
